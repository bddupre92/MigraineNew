...
class MigrainePerformanceMetrics:
    ...
    def calculate_metrics(self, model, X_test_list, y_test):
        ...
        # Save metrics
        self._save_metrics(all_metrics, y_test, y_pred_prob)
    ...
    def _calculate_threshold_optimized_metrics(self, y_true, y_pred_prob):
        ...
        optimal_conf_matrix = confusion_matrix(y_true, y_pred_optimal)
    ...
    def _save_metrics(self, metrics, y_true, y_pred_prob):
        """
