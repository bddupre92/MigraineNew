...
from pygmo_integration import MigraineMoEModel, ExpertHyperparamOptimization, GatingHyperparamOptimization, EndToEndMoEOptimization
...
class MigrainePredictionModel:
    ...
    def _preprocess_data(self, X_train, X_val, X_test):
        ...
        # Adjust target variables to match sequence length
        # When creating sequences, we lose (sequence_length - 1) samples at the beginning
    ...
    def build_model(self, expert_configs, gating_config, e2e_config=None):
        ...
        if e2e_config:
            ...
            self.model.compile(
                optimizer=optimizers.Adam(learning_rate=e2e_config['learning_rate']),
