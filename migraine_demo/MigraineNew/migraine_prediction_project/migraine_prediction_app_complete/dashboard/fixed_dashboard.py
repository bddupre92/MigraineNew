        ...
        if ('original_expert_contributions' in st.session_state and 
            ...
            with tab1:
                ...
                stats_df_original = pd.DataFrame({
                    ...
                    expert_names[3]: [stat[3] for stat in original_stats.values()]
                })
            ...
            with tab2:
                ...
                stats_df_optimized = pd.DataFrame({
                    ...
                    expert_names[3]: [stat[3] for stat in optimized_stats.values()]
                })
        ...
        if submitted:
            ...
            if 'original_predictions' in st.session_state and 'optimized_predictions' in st.session_state:
                ...
                if original_model is not None and optimized_model is not None:
                    # Format input for prediction
                    formatted_input = format_input_for_prediction(input_data)
                    
                    # Get predictions
                    original_pred = original_model.predict(formatted_input, verbose=0)
                    optimized_pred = optimized_model.predict(formatted_input, verbose=0)
