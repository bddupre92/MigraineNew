...
def main():
    """Main function for the expert weights visualization dashboard."""
    st.set_page_config(
        page_title="Expert Weights Visualization",
        page_icon="🧠",
        layout="wide",
    ...
    page = st.sidebar.radio(
        ...
        ["Expert Weights", "Network Diagram", "Decision Process", "Performance Comparison"]
    )
